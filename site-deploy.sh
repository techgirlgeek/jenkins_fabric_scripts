...
ssh prodweb "cd /var/www/web/$1.colorado.edu/public && git fetch && git rebase && drush updb -y && drush fra -y && drush cc all && wget --no-check-certificate -O - -q https://a0.hdslc.colorado.edu/clear_apc.php" 
